...
windows: dist/guri-windows-amd64 dist/guri-windows-386
...
dist/guri-windows-amd64: GOOS = windows
dist/guri-windows-amd64: GOARCH = amd64
dist/guri-windows-386: GOOS = windows
dist/guri-windows-386: GOARCH = 386
dist/guri-%:
	GOARCH=$(GOARCH) GOOS=$(GOOS) go build -o $@ src/*.go
